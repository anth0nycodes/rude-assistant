...
- [ ] One pre-written insult when slouching detected

### Phase 2: Make It Talk

- [ ] Text-to-speech integration
- [ ] Multiple insult variations
...
## Content/Showcase Ideas

Document the build process:

- The first time it successfully roasts you
- Compilation of the worst/funniest insults
- Me trying to work while it harasses me
- Behind-the-scenes of training it to be meaner
- Day-in-the-life with the assistant running
- Stats after a week of usage
